...
const QString SYSTEM_PROMPT = QStringLiteral(
    ...
    "\n"
    "Розпізнавані аліаси (можеш писати ПРОСТО назву): chrome, edge, firefox, "
    "brave, opera, discord, telegram, slack, teams, zoom, spotify, vlc, obs, "
    "steam, epic, vscode (або code), notepad++, sublime, obsidian, figma, "
    "notepad, calc, explorer, cmd, powershell, taskmgr, paint, snippingtool. "
    "Якщо аліаса нема — пиши шлях до .exe або URL.\n"
    "\n"
